...
public class Dashboard extends JFrame {
    ...
    //         ) {
    //             String getDatabaseFileTime = item.getDatabaseDate();
    //             String getLocalFileTime = item.getLocalDate();
    
    //             boolean changeDatabaseFile = isDatabaseOlder(getDatabaseFileTime, getLocalFileTime);
    //             if (changeDatabaseFile) {
    //                 System.out.println(item.getFilename() + " must be changed");
    ...
    //                     // Manually encode and upload file
    ...
    //                     out.println(uploadCommand);
    
    //                     String uploadResponse = in.readLine();
    //                     if ("OK".equals(uploadResponse)) {
    //                         System.out.println("File reuploaded successfully: " + item.getFilename());
    //                     } else {
    //                         System.out.println("Failed to upload file: " + item.getFilename() + " → Server said: " + uploadResponse);
    //                     }
    //                 } else {
    //                     System.out.println("Failed to delete file on server: " + item.getFilename());
    //                 }
    ...
    //     JOptionPane.showMessageDialog(this, "Files synchronized.");
    // }
